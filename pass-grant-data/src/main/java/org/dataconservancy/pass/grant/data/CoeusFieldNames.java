...
public class CoeusFieldNames {
    ...
    public static final String C_DIRECT_FUNDER_LOCAL_KEY = "SPOSNOR_CODE";// misspelling in COEUS view - if this gets corrected
    ...
    public static final String C_USER_LOCAL_KEY = "EMPLOYEE_ID";
